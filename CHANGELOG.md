...
- Для тем Material Design (Android 5.0 и выше) служебные надписи теперь имеют не красный/желтый/зеленый цвета, а один определенный соответствующий теме цвет.
