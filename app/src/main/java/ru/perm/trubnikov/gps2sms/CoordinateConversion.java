...
public class CoordinateConversion {
    ...
    public String latLon2UTMH(double latitude, double longitude) {
        LatLon2UTM c = new LatLon2UTM();
        return c.convertLatLonToUTMH(latitude, longitude);
    ...
    private class LatLon2UTM {
        public String convertLatLonToUTM(double latitude, double longitude) {
            ...
            UTM = longZone.replace(" ", "") + " " + latZone.replace(" ", "") + " " + String.format(Locale.US, "%10.2f", _easting).replace(" ", "") + " " + String.format(Locale.US, "%10.2f", _northing).replace(" ", "");

            //String lo = String.format(Locale.US, "%10.2f", _easting);
        ...
        public String convertLatLonToUTMH(double latitude, double longitude) {
            validate(latitude, longitude);
            String UTM = "";
